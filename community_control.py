...
def community_control(community, nrow, main): 
    '''
    controls the number of individuals in mainland so it doesnt get 
    full too quickly.
    allows 60% of mainland to be occupied
    community : the list of plants in community.
    nrow dimentions of mainland.
    main : dimentions of mainland.
    ...
    for plant in community: 
        ...
        if plant.pos[0] < main: #so in mainland
