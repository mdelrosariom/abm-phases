...
def data(community, mainland_island, current_time_step, rep):
    ...
    df.to_excel(f"C:/Users/mdrmi/OneDrive/Escritorio/ABM_PHASES_SIMU/output_data_phase_1_1000_run_10_sps/phase_1_10_per_resoueces_standard_simu_{rep}{current_time_step}.xlsx", index=False)
